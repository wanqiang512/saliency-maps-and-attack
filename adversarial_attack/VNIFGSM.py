...
class VNIFGSM:
    ...
    def __init__(
            self, model, eps=16 / 255, alpha=1.6 / 255, steps=10, decay=1.0, N=20, beta=1.5
    ):
        self.eps = eps
        self.steps = steps
        self.decay = decay
    ...
    def forward(self, images, labels):
        ...
        for _ in range(self.steps):
            ...
            outputs = self.model(self.TNormalize(nes_images))
            ...
            for _ in range(self.N):
                ...
                outputs = self.model(self.TNormalize(neighbor_images))
                cost = loss(outputs, labels)
